...
import com.phegondev.PhegonHotel.utils.EmailUtils;
...
public class BookingService implements IBookingService {
    ...
    public Response saveBooking(Long roomId, Long userId, Booking bookingRequest) {
        ...
        try {
            ...
            emailUtils.sendBookingConfirmationMail(user.getEmail(), user.getName(),bookingConfirmationCode, bookingRequest.getCheckInDate().format(formatter), bookingRequest.getCheckOutDate().format(formatter), room.getRoomType(), bookingRequest.getTotalNumOfGuest());
